...
stl10 = models.stl10_model_brelu.stl10
VGG = models.vgg_brelu.VGG
ResNeXt29_2x64d = models.resnext_brelu.ResNeXt29_2x64d
...
def main():
    ...
    if opt.net is None:
        ...
        net = VGG("VGG16", opt.noiseInit)
    elif opt.net == "resnext":
        net = ResNeXt29_2x64d(opt.noiseInit)
    elif opt.net == "stl10_model":
        net = stl10(32, opt.noiseInit)
    else:
