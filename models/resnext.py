...
def ResNeXt29_8x64d(std=0):
    return ResNeXt(num_blocks=[3,3,3], cardinality=8, bottleneck_width=64, std=std)

def ResNeXt29_32x4d(std=0):
    return ResNeXt(num_blocks=[3,3,3], cardinality=32, bottleneck_width=4, std=std)
