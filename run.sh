...
CUDA_VISIBLE_DEVICES=0 ./main2.py --lr 0.1 --dataset ${dataset} --root ${root} --net ${model} --noiseInit ${noise_init} --noiseInner ${noise_inner} --modelOut ./${model}/noise_${noise_init}_${noise_inner}.pth > ./${model}/log_noise_${noise_init}_${noise_inner}.txt
